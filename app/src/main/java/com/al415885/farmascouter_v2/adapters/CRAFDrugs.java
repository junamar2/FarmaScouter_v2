 ...
 * @version (2020 - 2021)
 */
public class CRAFDrugs extends RecyclerView.Adapter<CRAFDrugs.ViewHolder> {

    /* The list of elements */
    private List<MedSecond> list;
    private OnItemClickListener onItemClickListener;
    private OnLongItemClickListener onLongItemClickListener;

    /** Constructor for the class */
    public CRAFDrugs(OnItemClickListener onItemClickListener,
