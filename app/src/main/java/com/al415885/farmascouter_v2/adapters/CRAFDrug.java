 ...
 * @version (2020 - 2021)
 */
public class CRAFDrug extends RecyclerView.Adapter<CRAFDrug.ViewHolder> {

    /* The list of elements */
    private List<SNOMEDCTFourthRelations> list;
    private OnItemClickListener onItemClickListener;
    private OnLongItemClickListener onLongItemClickListener;

    /** Constructor for the class */
    public CRAFDrug(List<SNOMEDCTFourthRelations> list){
        this.list = list;
    }
