 ...
 */
public class HomeFragmentPS extends Fragment {

    // UI elements
    private RecyclerView rvHomeFragment;
    private List<MedPSSecond> rvList;
    private CRAFHomePS adapter;
    ...
    private void initialiseVariables(){
        ...
        this.adapter = new CRAFHomePS(this.rvList);
    }
